...
# Индивидуальные логи коммитов для максимального беспалевия
...
safe_push() {
  ...
  # Скачиваем изменения других ребят, чтобы пуш прошел без ошибок
  git pull origin main --rebase --no-edit
  git push origin main
}

# Интервал пауз (7-15 сек) для реактивной скорости
human_pause() {
